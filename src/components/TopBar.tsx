    ...
    <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-5 sticky top-0 z-40 gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded border border-gray-300 hover:border-[#003580] bg-gray-50 hover:bg-slate-100 text-xs font-semibold text-gray-700 transition-colors"

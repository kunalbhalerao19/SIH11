    ...
    <header className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-5 sticky top-0 z-40 gap-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded border border-gray-300 hover:border-[#003580] bg-gray-50 hover:bg-slate-100 text-xs font-semibold text-gray-700 transition-colors cursor-pointer"
        ...
        <button
          ...
          className="relative p-1.5 text-gray-600 hover:text-gray-900 rounded hover:bg-gray-100 transition-colors cursor-pointer"
        ...
        <div className="relative">
          ...
          >
            <div className="w-7 h-7 rounded bg-[#003580] text-white flex items-center justify-center text-xs font-bold shadow-none">
          ...
          {/* Profile Menu Popup */}
          {showProfileMenu && (
            <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-md border border-gray-200 py-2 z-50 animate-fade-in">
              ...
              <div className="py-1">
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-xs text-gray-700 hover:bg-gray-50 flex items-center gap-2 font-medium cursor-pointer"
                >

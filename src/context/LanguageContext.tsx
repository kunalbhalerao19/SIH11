...
const TRANSLATIONS: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    'nav.sectorAnalytics': 'क्षेत्रवार विश्लेषण (Sectors)',
    ...
    'nav.mapView': 'प्राथमिकता मानचित्र (Priority Map)',
    'nav.dataSources': 'डेटा स्रोत व रजिस्ट्री',
    'nav.dataQuality': 'डेटा गुणवत्ता व ईटीएल',
